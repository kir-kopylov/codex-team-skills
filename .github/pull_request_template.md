...
- [ ] Заголовок и описание PR проходят metadata gate: русский пользовательский текст, allowlist латиницы, приватные маркеры и поле «Когда не использовать».
- [ ] Комментарии и review написаны на русском; технические имена, пути и команды оставлены как есть.
- [ ] `python -m pytest` проходит.
- [ ] Если менялись тесты: в PR объяснено, какой инвариант теста сохранён, уточнён или сознательно изменён, и почему новая проверка не даёт false green.
