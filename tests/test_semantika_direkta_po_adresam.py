# -*- coding: utf-8 -*-
"""Скил-тест semantika-direkta-po-adresam: инварианты книги, стем-эвристики, вердиктов,
...
SCRIPT = Path(__file__).resolve().parents[1] / "plugins/team-skills/skills/semantika-direkta-po-adresam/scripts/semantika.py"
