# -*- coding: utf-8 -*-
"""Скил-тест smeta-remonta-do-dogovora: строит книгу и проверяет инварианты статически
...
SCRIPT = REPO / "plugins/team-skills/skills/smeta-remonta-do-dogovora/scripts/build_smeta_xlsx.py"
