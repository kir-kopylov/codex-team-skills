...
| --- | --- | --- |
| Без дословного триггера | 140 из 165 | 84,8% |
| С дословным триггером | 32 из 33 | 97,0% |
| Все входы | 172 из 198 | 86,9% |

Из 26 промахов 22 ушли в чужой навык и 4 — в ответ «ни один». Случаев без
...
| `kontrakt-tseli-do-starta` | `pravilo-iz-zhurnala-sboev` | 2 |
...
- Девять промахов из 26 — у одного навыка `kontrakt-tseli-do-starta`, и уходят
  они каждый раз в разное место. Это не пара соседей, а описание, которое по
  входу не отличимо сразу от нескольких навыков.
