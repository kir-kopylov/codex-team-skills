...
- может установить скиллы локально через один подписанный installer;
- получает новые скиллы через signed release и автообновление раз в двое суток;
...
installer/                        # signed user-mode установка, auto-update, repair, status и uninstall
