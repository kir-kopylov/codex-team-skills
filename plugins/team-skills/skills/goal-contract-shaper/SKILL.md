...
2. **Одна итерация**: атомарный круг loop, вход, действие Codex, решение пользователя, действие в мире, результат, что узнали, статусы, retry, ожидание и конец шага.
...
6. **Разрешенные и запрещенные действия**: что агент может обсуждать, рекомендовать, готовить и выполнять; какие реальные действия, обязательства, расходы, сообщения и изменения состояния требуют решения пользователя.
...
9. **Данные**: источники, свежесть, provenance, исключенные данные, изменчивые сведения, достаточное доказательство и правила live-state.
...
Статус
[что закрыто и что еще не закрыто; текущий размер контракта в знаках относительно лимита целевой команды, например ~2100/4000]
...
- Если ограничение целевой команды неизвестно, спросите пользователя или проверьте коротким текстом опытным путем до сдачи финала; узнанное ограничение занесите в exception-log для переноса в skill.
