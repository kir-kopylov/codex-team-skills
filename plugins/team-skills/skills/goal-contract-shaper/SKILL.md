...
- короткое различие между проверяемым контрактом и обычной переформулировкой цели.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Проверяемый контракт цели»** (@kir-kopylov) для <кратко назовите действие и объект>?
