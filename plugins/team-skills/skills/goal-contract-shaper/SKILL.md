...
Блок `Что будет достаточным ответом` не может впервые вводить нового исполнителя, канал, аккаунт, полномочие, внешнее действие или ручной шаг пользователя. Он только показывает форму ответа на уже заданный вопрос и не вводит звенья, которых нет в принятом контракте или самом вопросе. Если нужное звено цепочки исполнимости ещё не принято, назовите его незакрытым и задайте один настоящий вопрос только тогда, когда выбор действительно принадлежит пользователю.
