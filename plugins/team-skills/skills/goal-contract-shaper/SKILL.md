...
description: >-
  Используйте этот skill, когда пользователь просит проверить, подходит ли сырая цель для /goal, сформулировать /goal-контракт, довести цель до проверяемого финала или не дать AI-loop преждевременно перейти к выполнению. Skill выявляет универсальную грамматику деятельности: объект работы, создаваемую ценность, роли, единицы действия/проверки/потери, текущие сигналы, стоимость, риски, данные, цикл и журнал. Особенно полезен для задач с live-state, внешними системами, рисками, авторизацией, деньгами, сроками, браузером, API, терминалом или финалом, который нужно проверить внешним артефактом. Skill не выполняет целевую задачу и не запускает /goal.
---
