...
3. **Проверка шага и финала**: какие внешние доказательства подтверждают шаг и итог; кто проверяет и кто имеет право принять результат.
...
7. **Память**: какие логи, артефакты, сбои, уроки, состояния, владельцы действий, результаты кругов и статусы сохраняются.
...
Когда универсальная грамматика и пункты 0-11 закрыты, выведите цель в одном блоке `/goal` и спросите явное подтверждение:
