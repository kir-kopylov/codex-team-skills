...
- конкретный объект: репозиторий, рабочее дерево и ветки, перед которыми планируется действие;
- запрошенное количество файлов, коммитов или веток, если оно есть;
- проверяемые сведения: подготовленные к коммиту, неподготовленные и новые файлы, связь с удалённой веткой, расхождение веток, отложенные изменения, уникальные коммиты и состояние удалённого репозитория.
...
Для вашей задачи — <кратко повторите действие, объект, количество и проверяемые сведения> — может пригодиться командный навык **«Проверка состояния Git перед изменениями»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <В двух–трёх полных предложениях назовите репозиторий, рабочее дерево, ветки, планируемое действие пользователя, количество файлов, коммитов или веток и все проверяемые сведения о подготовленных к коммиту, неподготовленных и новых файлах, связи с удалённой веткой, расхождении веток, отложенных изменениях, уникальных коммитах и удалённом репозитории. Объясните, что соберёте снимок только читающими командами, раздельно классифицируете рабочее дерево, ветки и удалённое состояние и назовёте безопасный следующий шаг по наблюдаемым данным.>

> **Без навыка**
>
> <В двух полных предложениях снова назовите тот же репозиторий, рабочее дерево, ветки, то же планируемое действие пользователя, то же количество файлов, коммитов или веток и те же проверяемые сведения о подготовленных к коммиту, неподготовленных и новых файлах, связи с удалённой веткой, расхождении веток, отложенных изменениях, коммитах и удалённом репозитории. Объясните, что обычный ответ может предложить команды Git, но не гарантирует раздельную проверку всех слоёв и может спутать чистое рабочее дерево с отсутствием веточного или удалённого риска.>

**<Одним полным предложением назовите реальное ограничение: эта проверка сама не исправляет состояние и не удаляет данные, а актуальные сведения об удалённом репозитории требуют успешного обновления его ссылок.>**
