...
1. Ближайший `AGENTS.md` и названные в нём route, contract, registry или state-файлы задают правила и ожидаемый маршрут проекта.
...
3. Прочитайте ближайший `AGENTS.md`, затем только прямо названные им управляющие файлы. Не считайте открытый пункт уже принятым.
