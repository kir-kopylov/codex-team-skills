...
Применить **«Восстановление прерванной цели»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <возобновления названной цели или задачи>?

**С навыком:** источники состояния сверяются в режиме чтения, повторы отмечаются, затем предлагается один безопасный следующий шаг.

**Без навыка:** результат — продолжение по доступному контексту без защиты от повтора внешнего действия.
