...
- конкретный объект: прерванная цель, задача, репозиторий или внешний результат, состояние которого нужно восстановить;
- запрошенное количество: число целей, репозиториев, внешних действий или следующих шагов, если оно указано;
- проверяемые сведения: управляющие файлы, состояние Git, постоянные результаты, текущий статус внешних действий, контрольная точка и запрет на повтор уже выполненного.
...
Для вашей задачи — <кратко повторите действие, прерванную цель или задачу, количество целей или следующих шагов и проверяемые сведения> — может пригодиться командный навык **«Восстановление прерванной цели»**.
...
> **С навыком**
>
> <В двух–трёх полных предложениях снова назовите действие пользователя, прерванную цель или задачу, запрошенное количество целей, репозиториев, внешних действий или следующих шагов и все проверяемые сведения. Объясните, что в режиме только чтения сопоставите управляющие файлы, Git, постоянные результаты и текущий статус внешних действий, отметите противоречия и действия, которые нельзя повторять, а затем назовёте ровно один безопасный следующий шаг.>

> **Без навыка**
>
> <В двух–трёх полных предложениях снова назовите то же действие пользователя, ту же прерванную цель или задачу, то же количество целей, репозиториев, внешних действий или следующих шагов и те же проверяемые сведения. Объясните, что обычный ответ может пересказать доступный контекст и предложить продолжение, но не гарантирует сверку независимых источников, обнаружение уже выполненного внешнего действия и защиту от его повтора.>

**<Одним полным предложением объясните, что восстановление не исполняет следующий шаг и не может выбирать между несколькими целями или репозиториями без однозначного указания пользователя.>**
