...
```text
Опрос по skill:
1. Что в этом использовании karta-sistemy-do-pravok было полезно?
...
`~/.codex/skill-runs/karta-sistemy-do-pravok/usage-feedback.jsonl` через
...
в приватный `~/.codex/skill-runs/karta-sistemy-do-pravok/exception-log.jsonl`;
