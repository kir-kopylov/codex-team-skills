...
description: "«Проверь семантику PR», «CI зелёный — тесты доказывают исправление?», «сломан код или тест?», «новая регрессия или старое падение?», «не ослабили ли проверку ради CI?»."
---
