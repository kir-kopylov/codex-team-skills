...
description: "«Проверь семантику PR», «тесты доказывают исправление?», «сломан код или тест?», «новая регрессия или старое падение?», «CI зелёный и PR влит — доказан ли результат?»: докуда доказан результат PR — diff, CI, merge, запуск."
---
