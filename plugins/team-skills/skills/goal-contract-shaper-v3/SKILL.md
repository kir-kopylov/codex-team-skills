...
Этот экспериментальный навык запускайте только при явном вызове `goal-contract-shaper-v3`. Смысловой запрос без прямого вызова маршрутизируйте в базовый `goal-contract-shaper`; не запускайте v3 и не спрашивайте о его применении.
