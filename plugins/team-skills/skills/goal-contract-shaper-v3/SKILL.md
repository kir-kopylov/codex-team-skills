...
- конкретный объект: сырая цель, создаваемый результат и среда выполнения;
- короткое различие: усиленный контракт с прямыми проверками вместо базового контракта.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Усиленная проверка контракта цели»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <кратко назовите действие и цель>?

**С навыком:** <назовите только контракт с проверкой полномочий, сквозной пробой и прямым критерием завершения; сама цель не выполняется>.

**Без навыка:** <назовите только базовый контракт без этих проверок>.
