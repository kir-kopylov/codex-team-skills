...
Применить **«Проверка причин сбоя»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <диагностики названного сбоя>?

**С навыком:** один безопасный опыт различает две причинные версии по заранее названным исходам при неизменных остальных факторах.

**Без навыка:** результат — перечень вероятных причин и проверок без причинного контраста и заранее заданной интерпретации.
