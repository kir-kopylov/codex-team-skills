...
- значения, на которых строится контраст, подтверждены как различные на
  границе самой системы; последовательность действий не доказывает, что
...
До интерпретации подтвердите, что система сохранила различающиеся значения
проверяемых ключей. Совпавшие времена, округление, нормализация или неизвестное
правило разрешения равенства делают опыт `invalid_test`, даже если итоговая
последовательность совпала с одним прогнозом.
