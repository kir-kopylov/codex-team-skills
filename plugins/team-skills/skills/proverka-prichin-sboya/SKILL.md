...
description: "«Проверь причины сбоя», «не гадай, а проверь», «тут работает, там нет», «интерфейс одно, система другое», «по какому правилу это на самом деле работает?»: опыт на нейтральном воспроизводимом поведении."
---
