...
description: "«Проверь причины сбоя, не гадай», «тут работает, там нет», «зелёный статус, а у пользователя старое — какая из двух причин», «по какому правилу это на самом деле работает?»: опыт на нейтральном воспроизводимом поведении."
---
