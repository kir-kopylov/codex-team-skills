...
description: "«Изучи чат и предложи навыки», «что формализовать из работы», «навыки или патчи извлечь», «повторяемые процессы в диалоге», «отсей ложные навыки»: кандидаты по приоритету."
---
