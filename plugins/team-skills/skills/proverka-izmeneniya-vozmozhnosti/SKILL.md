...
description: "«Правда новая возможность?», «сравни с предыдущей версией», «раньше было нельзя», «новый результат или новый способ», «смена default — не новая функция». Вердикт по источникам."
---
