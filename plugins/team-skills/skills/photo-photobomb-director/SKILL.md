...
При автосрабатывании на смысловое сходство сначала извлеките из текущего запроса действие пользователя, конкретное исходное фото, запрошенное количество добавляемых персонажей или деталей, если оно есть, и проверяемые сведения: кого и что сохранить, место появления, позу, выражение, настроение, аудиторию и допустимую степень абсурда.
...
Для вашей задачи — <кратко повторите действие пользователя, конкретное фото, запрошенное количество персонажей или деталей и проверяемые сведения> — может пригодиться командный навык **«Режиссёр фотобомбинга»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <Полными предложениями снова назовите действие пользователя, исходное фото, количество персонажей или деталей и проверяемые сведения. Объясните, что будут отдельно зафиксированы элементы, которые нельзя менять, выбран уровень усиления и размещение вмешательства, а затем будет собрана и применена точная инструкция для редактирования с проверкой сохранности исходной сцены.>

> **Без навыка**
>
> <Полными предложениями снова назовите то же действие пользователя, то же исходное фото, количество персонажей или деталей и проверяемые сведения. Объясните, что обычный ответ может предложить шутливую идею или общий запрос для редактора, но не гарантирует управляемый уровень абсурда, точное место вмешательства и явную защиту лиц, поз, текста и композиции, которые пользователь попросил сохранить.>

**Навык требует доступного исходного изображения и не может гарантировать пиксельное сохранение деталей, если используемый редактор не поддерживает точное локальное изменение.**
