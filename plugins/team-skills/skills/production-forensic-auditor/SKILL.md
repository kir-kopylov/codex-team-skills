...
Применить **«Производственный аудит решения»** (@kir-kopylov) для <аудита названного проекта или текста>?

**С навыком:** утверждения разделяются на факты и допущения, проверяются предметными линзами и получают приоритет по эксплуатационному влиянию.

**Без навыка:** результат — редакторская оценка без системной проверки метрик, данных, интеграций, экономики и эксплуатационных обязанностей.
