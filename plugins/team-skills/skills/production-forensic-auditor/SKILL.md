...
При автосрабатывании на смысловое сходство сначала извлеките из текущего запроса действие пользователя, конкретный текст, проект или архитектурное предложение, запрошенное количество тезисов или направлений проверки, если оно есть, и проверяемые сведения: цели, метрики, источники данных, интеграции, экономика, риски, ответственность и признаки работы в эксплуатации.
...
Для вашей задачи — <кратко повторите действие пользователя, конкретный текст или проект, запрошенное количество тезисов и проверяемые сведения> — может пригодиться командный навык **«Производственный аудит решения»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <Полными предложениями снова назовите действие пользователя, текст или проект, запрошенное количество тезисов или направлений проверки и проверяемые сведения. Объясните, что утверждения будут проверены через предметные линзы, отделены факты, допущения и архитектурные фантазии, а находки будут приоритизированы по влиянию на работу в эксплуатации с доказательствами и ограниченным объёмом исправлений.>

> **Без навыка**
>
> <Полными предложениями снова назовите то же действие пользователя, тот же текст или проект, то же количество тезисов или направлений проверки и проверяемые сведения. Объясните, что обычный ответ может дать редакторскую оценку и заметить отдельные слабые места, но не гарантирует систематическую проверку метрик, данных, интеграций, экономики и эксплуатационных обязанностей или явное разделение фактов и допущений.>

**Аудит ограничен предоставленным текстом и доступными доказательствами: он не подтверждает работу системы в эксплуатации и не расширяет исправления за пределы объёма, который запросил пользователь.**
