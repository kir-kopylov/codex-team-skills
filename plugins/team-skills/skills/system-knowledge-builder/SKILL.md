...
Применить **«Проверяемая карта системы»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <описания названной системы>?

**С навыком:** утверждения связываются с датированными источниками, а противоречия и неизвестное остаются явными в воспроизводимой карте.

**Без навыка:** результат — обзор материалов без прослеживаемости, проверки свежести и отделения исследования от устойчивой документации.
