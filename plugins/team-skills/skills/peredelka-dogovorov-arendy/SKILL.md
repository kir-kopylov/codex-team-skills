...
При автосрабатывании на смысловое сходство сначала извлеките из текущего запроса действие пользователя, конкретный объект найма и пакет документов, запрошенное количество документов или экземпляров, если оно есть, и проверяемые сведения: стороны, адрес, даты, суммы, сальдо, улучшения, основания расторжения и подписные блоки.
...
Для вашей задачи — <кратко повторите действие пользователя, конкретный объект найма и пакет документов, запрошенное количество документов и проверяемые сведения> — может пригодиться командный навык **«Переоформление договоров найма»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <Полными предложениями снова назовите действие пользователя, объект найма и пакет документов, запрошенное количество документов или экземпляров и проверяемые сведения. Объясните, что исходные файлы будут разобраны, изменения спланированы по документам, затем договоры и соглашения будут собраны с едиными сторонами, адресом, датами и суммами и пройдут перекрёстную проверку всего пакета.>

> **Без навыка**
>
> <Полными предложениями снова назовите то же действие пользователя, тот же объект найма и пакет документов, то же количество документов или экземпляров и проверяемые сведения. Объясните, что обычный ответ может подготовить отдельный текст договора или соглашения, но не гарантирует сверку всех исходников, согласованность реквизитов и сумм между документами и проверку следов старого наймодателя во всём пакете.>

**Навык не заменяет юридическое заключение: отсутствующие личные данные остаются пустыми, а противоречия в сторонах, суммах или датах требуют решения пользователя до финальной сборки.**
