...
Опрос задаётся один раз — после завершения операции обслуживания — статус, обновление, удаление или восстановление, не посреди рабочего цикла. Если пользователь уже ответил «пропустить» в этой сессии, не переспрашивайте.

```text
Опрос по skill:
1. Что в этом использовании team-skills-maintenance было полезно?
