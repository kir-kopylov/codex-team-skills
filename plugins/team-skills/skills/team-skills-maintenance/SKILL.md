...
Применить **«Обновление библиотеки навыков»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <обновления названной библиотеки и её копий>?

**С навыком:** полный разрешённый цикл сохраняет восстановление и завершается лишь проверкой видимости в новой сессии.

**Без навыка:** результат — обновлённые файлы без устранения конфликтующей копии и проверки активного интерфейса.
