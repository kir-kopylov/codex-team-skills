...
- `LEGACY_TRANSITION_REQUIRED` — plugin отсутствует, но найден хотя бы один след прежней схемы; чистую установку нельзя начинать до процедуры переподключения;
...
### 4. Проверить Следы Старой Схемы До Первой Установки
