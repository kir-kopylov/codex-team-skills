...
- короткое различие между работой по процедуре навыка и точечной правкой без неё.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Подготовку командного навыка»** (@kir-kopylov) для <кратко назовите действие и объект>?
...
- для каждого нового или существенно изменённого skill наблюдаемая проба
  первого ответа в свежем контексте получила `BEHAVIOR_PROBE_PASS`; структурный
  pytest не выдан за такую пробу;
