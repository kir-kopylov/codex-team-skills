...
Если пользователь принёс имя, нарушающее эти правила, предложите два-три варианта по правилам и зафиксируйте выбор до генерации папки; существующие skills задним числом не переименовывайте.
...
Если в охват входит сам `add-team-skill`, его строку запускайте на
