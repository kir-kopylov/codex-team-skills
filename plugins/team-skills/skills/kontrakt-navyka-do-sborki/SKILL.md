...
description: "«Спроектируй контракт skill», «сделай skill contract из этого workflow», «из этого чата сделать skill», «нужен ли тут отдельный skill», «правила и анти-правила», «уроки инцидента»: только контракт, до сборки файлов."
---
