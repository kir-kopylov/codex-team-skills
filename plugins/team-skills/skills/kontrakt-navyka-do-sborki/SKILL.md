---
name: kontrakt-navyka-do-sborki
...
- пользователь просит создать файлы в repo, добавить examples, catalog, tests или PR -> передайте задачу в `dobavlenie-navyka-v-biblioteku`;
- пользователь просит разобрать идею без намерения создать повторяемый skill -> используйте `razbor-svoey-syroy-idei`;
