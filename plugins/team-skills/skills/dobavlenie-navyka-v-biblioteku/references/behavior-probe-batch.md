...
Если реальный внешний охват включает `dobavlenie-navyka-v-biblioteku`, проверьте его строго в
два уровня:

1. Внешний пакет хранит строку реального `dobavlenie-navyka-v-biblioteku` и загружает в неё
...
2. Только этой строке дайте одноразовый внутренний fixture от того же
   ...
   тестовых skills, а `dobavlenie-navyka-v-biblioteku` отсутствует. Первый ответ кандидата
...
внешняя строка `dobavlenie-navyka-v-biblioteku` получает обычный `BEHAVIOR_PROBE_PASS`,
...
`dobavlenie-navyka-v-biblioteku` в diff или граница двух уровней не доказаны, поставьте внешней
...
- нерекурсивный fixture строки `dobavlenie-navyka-v-biblioteku` снова включает оркестратор в
