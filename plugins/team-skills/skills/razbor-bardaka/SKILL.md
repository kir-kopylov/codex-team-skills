---
name: razbor-bardaka
description: "«Наведи порядок в заметках», «разбери бардак в закладках», «систематизируй коллекцию промптов», «упорядочи файлы, свалка», «разложи по папкам». Карта до перекладки."
---
