...
description: "«Продолжи прерванный /goal», «после падения Codex что сделано», «после обрыва чат уверяет, что commit и PR уже сделаны», «восстанови состояние по файлам, не читая чат». Read-only: что не повторять и следующий шаг."
---
