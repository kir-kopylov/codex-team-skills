...
description: "«Терминал без интернета при VPN», «git не пушится, а браузер работает», «curl даёт 000», «включил VPN — терминал отвалился», «почини сеть терминала». Прокси и транспорт git."
---
