...
Применить **«Диагностика сети Windows-приложения»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <диагностики приложения>?

**С навыком:** слои приложения и системы разделяются безопасным опытом с откатом без самовольной смены настроек.

**Без навыка:** результат — типовые действия для VPN и DNS без доказанной причины и защиты от повтора гипотез.
