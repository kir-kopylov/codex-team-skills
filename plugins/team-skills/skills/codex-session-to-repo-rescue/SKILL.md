...
- короткое различие между доказанным переносом и командами восстановления без него.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Сохранение результата сессии в репозитории»** (@kir-kopylov) для <кратко назовите действие и сессию>?

**С навыком:** <назовите только доказанное происхождение и хэши разрешённых артефактов, чистоту переноса и результат в целевой ветке>.

**Без навыка:** <назовите только команды восстановления без доказательств происхождения и результата>.
