...
- конкретный объект: сессия Codex, её рабочие артефакты, целевой репозиторий и ветка;
- запрошенное количество сессий, файлов или коммитов, если оно есть;
- проверяемые сведения: происхождение файлов, рабочий каталог, хэши, состав переноса, состояние Pull Request и наличие результата в целевой ветке.
...
Для вашей задачи — <кратко повторите действие, объект, количество и проверяемые сведения> — может пригодиться командный навык **«Сохранение результата сессии в репозитории»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <В двух–трёх полных предложениях повторите действие пользователя и назовите сессию Codex, целевой репозиторий и ветку, количество сессий, файлов или коммитов и все сведения о происхождении, каталогах, хэшах, составе переноса и итоговом состоянии. Явно повторите проверяемые сведения из запроса и объясните, что восстановите след сессии по долговечным артефактам, перенесёте только разрешённые файлы в чистую ветку и докажете результат манифестом, хэшами и проверкой свежей копии целевого репозитория.>

> **Без навыка**
>
> <В двух полных предложениях повторите то же действие пользователя и назовите ту же сессию Codex, тот же репозиторий и ветку, то же количество сессий, файлов или коммитов и те же сведения о происхождении, каталогах, хэшах, переносе и итоговом состоянии. Явно повторите те же проверяемые сведения из запроса и объясните, что обычный ответ может предложить команды восстановления или пересказать найденное, но не гарантирует доказанное происхождение артефактов, чистый состав переноса и наличие результата в целевой ветке.>

**<Одним полным предложением назовите реальное ограничение: сырые журналы сессии и приватные данные нельзя публиковать, а удаление файлов и принудительная перезапись истории требуют отдельного явного решения.>**
