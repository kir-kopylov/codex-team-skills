...
description: "Применяет уже принятое изменение правила к связанным источникам работающей задачи: инструкции, сохранённому следующему шагу и существующему продолжению по расписанию. Используйте для «убери это правило из текущей работы», «примени новое условие к действующей задаче», «синхронизируй продолжение с новой договорённостью». Не выбирает новое правило, не переписывает историю и не возобновляет остановленную задачу."
---
