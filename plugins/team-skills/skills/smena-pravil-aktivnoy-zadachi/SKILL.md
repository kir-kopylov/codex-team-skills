...
По свежему чтению сравните принятое изменение с правилами и зависимыми действиями во всех найденных действующих источниках. Повторная команда или прежнее сообщение об успехе не доказывают ни наличия, ни отсутствия оставшейся правки. Отделите согласованные источники от тех, где ещё есть расхождение. Недоступный источник оставляйте непроверенным.
...
Меняйте только оставшиеся расхождения. Уже согласованные источники не перезаписывайте. Если все действующие источники доступны и согласованы, переходите к проверке в шаге 5 без записей: не повышайте версии, не обновляйте продолжение и не добавляйте событие о новой смене правила. При частичном применении исправьте только несогласованную часть; неизвестное состояние не считайте согласованным.
...
- Если продолжение ещё противоречит принятому изменению, обновите его штатным средством по точному ID. Сохраните прежние расписание, получателя, настройки уведомлений и состояние запуска, если пользователь их не менял. Не создавайте замену существующей автоматизации. Если продолжения нет, не создавайте его ради изменения правила.
- Если в задаче уже ведётся журнал и вы действительно изменили источники, добавьте запись только о фактической правке и затронутых источниках; прежние события не удаляйте и не переписывайте. Повторная сверка без правок не является новой сменой правила. Не заводите новый журнал только для этого навыка.
...
Заново прочитайте затронутые источники и сохранённые настройки продолжения через соответствующее средство, в том числе если правок не потребовалось. Проверьте смысл правил и зависимых действий, а не только наличие или отсутствие прежних слов. Старое упоминание в истории допустимо, исполнимая ссылка на него — нет. Если при повторном чтении появилось расхождение, вернитесь к согласованию и исправлению только этой части.
...
Если изменений не было, сообщите «уже применено» и назовите проверенные источники и ближайший шаг. Не выдавайте проверку ранее сохранённого результата за новую правку.
