...
- конкретный объект: механизм или подсистема, которые начали разрастаться;
- короткое различие: доказательное решение вместо продолжения новых доработок.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Стоп лишнему усложнению»** (@kir-kopylov) для <кратко назовите действие и механизм>?

**С навыком:** <назовите только паузу расширения, восстановление исходного результата и одно доказательное решение; меры безопасности автоматически не убираются>.

**Без навыка:** <назовите только обсуждение вариантов без остановки доработок и решения по механизму>.
