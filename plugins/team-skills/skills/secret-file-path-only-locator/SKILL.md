...
- конкретный объект: разрешённые файлы, письма, облачные документы, заметки, репозитории, архивы или другие названные источники;
- запрошенное количество: число источников, аккаунтов, классов секретов или этапов проверки, если оно указано;
- проверяемые сведения: разрешённая область поиска, классы секретов, безопасный формат указателей, исключения, режим аудита или очистки и требуемая глубина покрытия.
...
Для вашей задачи — <кратко повторите действие, разрешённые источники, их количество и проверяемые сведения о поиске и очистке секретов> — может пригодиться командный навык **«Безопасный поиск копий секретов»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <В двух–трёх полных предложениях снова назовите действие пользователя, разрешённые источники, запрошенное количество источников, аккаунтов, классов секретов или этапов проверки и все проверяемые сведения. Объясните, что сначала проверите безопасность поискового механизма на синтетических данных, затем построите покрытие и отчёт только с безопасными указателями без значений, а очистку проведёте лишь после отзыва или замены секрета и отдельного согласования конкретной группы находок.>

> **Без навыка**
>
> <В двух–трёх полных предложениях снова назовите то же действие пользователя, те же разрешённые источники, то же количество источников, аккаунтов, классов секретов или этапов проверки и те же проверяемые сведения. Объясните, что обычный ответ может предложить команды поиска и общий порядок очистки, но не гарантирует подавление значений во всех каналах вывода, явную карту непроверенных источников и отзыв секрета до удаления копии.>

**<Одним полным предложением объясните, что навык не обходит права или шифрование, не раскрывает найденные значения и не удаляет файлы, версии, резервные копии или историю без отдельного точного разрешения.>**
