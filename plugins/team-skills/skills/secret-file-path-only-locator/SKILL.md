...
Применить **«Безопасный поиск копий секретов»** (@kir-kopylov) для <поиска в разрешённых источниках>?

**С навыком:** поиск проверяется на синтетике, а отчёт показывает только безопасные указатели; очистка требует отдельного согласия.

**Без навыка:** результат — команды поиска без гарантии сокрытия значений и карты непроверенных источников.
