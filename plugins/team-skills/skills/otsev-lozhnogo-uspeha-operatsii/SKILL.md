...
description: "«Ложный success», «успех раньше времени», «честно ли запуск завершён», «все пути к завершению», «completion gate после инцидента». Вердикт PASS/FALSE_SUCCESS/UNPROVEN."
---
