...
- конкретный объект: обновлятор, планировщик, фоновый процесс, адаптер или другая подсистема, которую нужно вывести из эксплуатации;
- запрошенное количество: число компонентов, репозиториев, платформ, старых установок или миграционных шагов, если оно указано;
- проверяемые сведения: точки запуска, конфигурация, код, тесты, документация, поставляемые файлы, следы старых установок, оставшийся контракт и допустимая очистка.
...
Для вашей задачи — <кратко повторите действие, удаляемую подсистему, количество компонентов или установок и проверяемые сведения> — может пригодиться командный навык **«Безопасное удаление подсистемы»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <В двух–трёх полных предложениях снова назовите действие пользователя, удаляемую подсистему, запрошенное количество компонентов, репозиториев, платформ, старых установок или миграционных шагов и все проверяемые сведения. Объясните, что составите карту всей поверхности подсистемы, удалите только доказанно принадлежащие ей части, сохраните узкую миграцию для старых установок и проверите отсутствие поставляемых хвостов и работоспособность оставшегося пути.>

> **Без навыка**
>
> <В двух–трёх полных предложениях снова назовите то же действие пользователя, ту же удаляемую подсистему, то же количество компонентов, репозиториев, платформ, старых установок или миграционных шагов и те же проверяемые сведения. Объясните, что обычный ответ может удалить названные файлы и ссылки, но не гарантирует поиск всех точек запуска, безопасную границу владения, миграцию уже установленных копий и доказательство отсутствия поставляемых хвостов.>

**<Одним полным предложением объясните, что удаление требует явного разрешения, точно установленного репозитория и границ владения, а неизвестные внешние установки нельзя очищать автоматически.>**
