...
Применить **«Безопасное удаление подсистемы»** (@kir-kopylov) для <вывода названной подсистемы из эксплуатации>?

**С навыком:** карта поверхности и границы владения направляют разрешённое удаление, миграцию старых установок и проверку оставшегося пути.

**Без навыка:** результат — удаление названных файлов без доказательства полноты и безопасности для старых установок.
