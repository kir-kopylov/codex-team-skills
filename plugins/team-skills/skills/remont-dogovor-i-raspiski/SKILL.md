...
Применить **«Договор и расписки на ремонт»** (@kir-kopylov) для <сборки названного пакета документов>?

**С навыком:** договор, расписки и акт согласованы по сторонам, работам, суммам и хронологии.

**Без навыка:** результат — отдельный документ без сквозной арифметической и смысловой сверки пакета.
