...
description: >
  ...
  ссылкой на перечень работ из `smeta-remonta-do-dogovora`, держит сквозные
  ...
  личных данных и рендерит через `verstka-docx-po-standartu`. Не используйте для договоров
  аренды и допсоглашений (`dopsoglasheniya-po-oplate`), для составления самой
  сметы (`smeta-remonta-do-dogovora`) или вместо юридического заключения.
---
...
1. **Соберите вход.** Стороны (заказчик, исполнитель), адрес объекта, перечень работ (лучше из `smeta-remonta-do-dogovora`), общая сумма, разбивка платежей (аванс и остаток или этапы), даты. Чего нет — спрашивайте; не выдумывайте.
