...
При автосрабатывании на смысловое сходство сначала извлеките из текущего запроса действие пользователя, конкретный физический объект или проблему, запрошенное количество решений, если оно есть, и проверяемые сведения: размеры, силы, материалы, среду, безопасность, бюджет, срок и критерий успеха.
...
Для вашей задачи — <кратко повторите действие пользователя, конкретный физический объект или проблему, запрошенное количество решений и проверяемые сведения> — может пригодиться командный навык **«Разнообразие физических решений»**.
...
> **С навыком**
>
> <Полными предложениями снова назовите действие пользователя, физический объект или проблему, количество решений и проверяемые сведения. Объясните, что сначала будет проверена реализуемость, затем решения будут разведены по разным физическим принципам, проверены по ограничениям, стоимости и безопасности и сведены к небольшому набору кандидатов с планом испытания.>

> **Без навыка**
>
> <Полными предложениями снова назовите то же действие пользователя, тот же физический объект или проблему, количество решений и проверяемые сведения. Объясните, что обычный ответ может провести мозговой штурм и перечислить идеи, но не гарантирует различие физических принципов, отсев нереализуемых решений, сравнение экономики и сведение идей к проверяемым кандидатам.>

**Навык не заменяет инженерный расчёт, испытание прототипа или сертификацию безопасности, поэтому критичные нагрузки и риски должен проверить профильный специалист.**
