...
- конкретный объект: физический объект или проблема и требуемые решения;
- короткое различие: отбор разных физических принципов вместо мозгового штурма.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Разнообразие физических решений»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <кратко назовите действие и физическую проблему>?

**С навыком:** <назовите только реализуемость, разные принципы, отсев и испытание; расчёт и сертификация остаются отдельно>.

**Без навыка:** <назовите только мозговой штурм без отбора и проверяемых кандидатов>.
