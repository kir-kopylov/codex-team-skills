...
Вёрстка выполняется по стандарту оформления скилла `verstka-docx-po-standartu`
...
работал и установленным в одиночку. `verstka-docx-po-standartu` остаётся референсом
...
# --- стандарт оформления (зеркало verstka-docx-po-standartu, без импорта) --------------
