...
description: "«Ветка отстала от main», «просто сделать rebase?», «что здесь моё, а что уже влито», «как донести работу до main», «спасать ли ветку». Пофайловый вердикт, без переноса."
---
