...
- конкретный объект: услуга, город или район и требуемые подрядчики;
- короткое различие: доказательное ранжирование вместо списка ссылок и общих рейтингов.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Доказательное сравнение местных подрядчиков»** (@kir-kopylov) для <кратко назовите действие и требуемых подрядчиков>?

**С навыком:** <назовите только корпус кандидатов, разведение одноимённых компаний и профильное ранжирование; живые цена, контакты и доступность требуют отдельной проверки>.

**Без навыка:** <назовите только ссылки и общие рейтинги без доказательного ранжирования>.
