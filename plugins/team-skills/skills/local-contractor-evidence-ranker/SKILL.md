...
При автосрабатывании на смысловое сходство сначала извлеките из текущего запроса действие пользователя, конкретную услугу и город или район, запрошенное количество подрядчиков, если оно есть, и проверяемые сведения: специализацию, релевантный опыт, отзывы, цену, контакты, график или доступность.
...
Для вашей задачи — <кратко повторите действие пользователя, конкретную услугу и местность, запрошенное количество подрядчиков и проверяемые сведения> — может пригодиться командный навык **«Доказательное сравнение местных подрядчиков»**.

Автор навыка — **@kir-kopylov**.

> **С навыком**
>
> <Полными предложениями снова назовите действие пользователя, услугу и местность, количество подрядчиков и проверяемые сведения. Объясните, что будет собран корпус подходящих подрядчиков, отделены одноимённые компании, сопоставлены профильные доказательства и независимые отзывы, а исключения и основания итогового ранжирования будут показаны явно.>

> **Без навыка**
>
> <Полными предложениями снова назовите то же действие пользователя, ту же услугу и местность, количество подрядчиков и проверяемые сведения. Объясните, что обычный поиск может собрать ссылки и краткие описания, но не гарантирует полный корпус, разведение одноимённых компаний и ранжирование по релевантным доказательствам вместо рекламы или общего рейтинга.>

**Ранжирование не подтверждает актуальные цену, контакты, график или готовность подрядчика выехать без отдельной проверки через доступный канал в текущий момент.**
...
```text
Опрос по skill:
1. Что в этом использовании local-contractor-evidence-ranker было полезно?
2. Что стоит доработать в skill или его формате?
Можно ответить коротко или написать "пропустить".
```

Если пользователь ответил, сохраните санированную карточку в `~/.codex/skill-runs/local-contractor-evidence-ranker/usage-feedback.jsonl` — лучше через bundled script:
