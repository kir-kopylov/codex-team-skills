...
- короткое различие между проверкой разрешений и советом по настройке без неё.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Проверка разрешений браузера»** (@kir-kopylov; экспериментальный; обратная связь @kir-kopylov) для <кратко назовите браузерную задачу и домены>?

**С навыком:** <назовите только проверку разрешений и пробный проход; целевая задача не выполняется>.

**Без навыка:** <назовите только совет по настройке без проверки каждого домена>.
