...
- конкретный объект: браузерная задача, сайты, домены и расширение, которым нужны разрешения;
- запрошенное количество сайтов или доменов, если оно есть;
- проверяемые сведения: наличие разрешения для каждого названного домена и отсутствие повторных окон согласия при пробном проходе.
...
Для вашей задачи — <кратко повторите действие, объект, количество и проверяемые сведения> — может пригодиться командный навык **«Проверка разрешений браузера»**.
...
> **С навыком**
>
> <В двух–трёх полных предложениях повторите действие пользователя и назовите браузерную задачу, количество сайтов или доменов, сами сайты и расширение, а также требуемые разрешения и отсутствие окон согласия. Явно повторите проверяемые сведения из запроса и объясните, что составите полный список доменов, сверите след разрешения на странице расширения и проведёте пробный проход по каждому названному домену до решения о запуске задачи.>

> **Без навыка**
>
> <В двух полных предложениях повторите то же действие пользователя и назовите ту же браузерную задачу, то же количество сайтов или доменов, те же сайты, расширение, разрешения и требование к окнам согласия. Явно повторите те же проверяемые сведения из запроса и объясните, что обычный ответ может подсказать настройки браузера, но не гарантирует сверку следа разрешения и пробный проход без повторных запросов на каждом названном домене.>

**<Одним полным предложением назовите реальное ограничение: проверка требует доступа к странице расширения и самим сайтам, но не выполняет вход, покупку, оплату или целевую браузерную задачу.>**
