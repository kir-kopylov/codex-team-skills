...
Самостоятельная проверка не заменяет перечисленные выше наблюдения, доступные только человеку: если агент физически не видит модалку или список разрешений, он обязан получить это наблюдение от человека.
