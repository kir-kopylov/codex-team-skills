...
- конкретный объект: исходный договор аренды или найма и требуемое дополнительное соглашение об оплате;
- запрошенное количество договоров или дополнительных соглашений, если оно есть;
- проверяемые сведения: стороны, дата и вид договора, адрес объекта, номер соглашения, месяц, сумма, день оплаты и формулировки подписного блока.
...
Для вашей задачи — <кратко повторите действие, объект, количество и проверяемые сведения> — может пригодиться командный навык **«Допсоглашение об оплате аренды»**.

Автор навыка — **@OfficeManEtazhy**.

> **С навыком**
>
> <В двух–трёх полных предложениях повторите действие пользователя и назовите исходный договор, дополнительное соглашение, количество договоров или дополнительных соглашений и все сведения о сторонах, дате, виде договора, адресе, номере соглашения, месяце, сумме, дне оплаты и подписях. Явно повторите проверяемые сведения из запроса и объясните, что извлечёте реквизиты из договора, покажете их пользователю на сверку, выберете нужную ветку оплаты, соберёте DOCX и визуально проверите документ перед передачей.>

> **Без навыка**
>
> <В двух полных предложениях повторите то же действие пользователя и назовите тот же исходный договор, то же дополнительное соглашение, то же количество договоров или дополнительных соглашений и те же сведения о сторонах, дате, виде договора, адресе, номере, месяце, сумме, дне оплаты и подписях. Явно повторите те же проверяемые сведения из запроса и объясните, что обычный ответ может подготовить текст соглашения, но не гарантирует сверку реквизитов с исходным договором, выбор правильной ветки оплаты и визуальную проверку готового DOCX.>

**<Одним полным предложением назовите реальное ограничение: нужен читаемый исходный договор и человеческая сверка реквизитов, а результат не является юридическим заключением.>**
...
- GitHub-аккаунт автора показан как `@OfficeManEtazhy`, имя и фамилия не используются;
