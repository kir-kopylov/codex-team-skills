...
- конкретный объект: исходный договор и требуемое дополнительное соглашение об оплате;
- короткое различие: сверка и проверка готового DOCX вместо подготовки одного текста.

Затем без вводного объяснения заполните и покажите следующую карточку:

Применить **«Допсоглашение об оплате аренды»** (@OfficeManEtazhy) для <кратко назовите действие и документы>?

**С навыком:** <назовите только извлечение и сверку реквизитов, выбор ветки оплаты, сборку и визуальную проверку DOCX>.

**Без навыка:** <назовите только текст соглашения без сверки исходного договора и готового файла>.
...
- автор указан как `@OfficeManEtazhy` в скобках в первой строке;
