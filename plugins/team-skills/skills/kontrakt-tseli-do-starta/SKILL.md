...
description: "«Проверь цель для /goal», «сформулируй /goal-контракт из сырой цели», «добавь completion gate», шаг незакрытого контракта: checklist, финальный блок под лимит знаков, goalrt; ценность, роли, потери. Задачу не выполняет."
---
