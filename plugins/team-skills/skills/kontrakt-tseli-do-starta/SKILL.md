...
7. **Память**: назовите хранилище, сохраняемый результат единицы, статус и порядок возобновления. Выберите достаточный режим по последствиям действий, а не только по длительности цели.
   ...
   Для одного исполнителя, который только читает источники и сохраняет воспроизводимые локальные результаты, достаточно учёта единиц в одном месте, например таблицы в отчёте. Укажите идентификатор единицы, указатель на исходник и результат, статус и следующий шаг. Сначала сохраните и проверьте результат, затем отмечайте единицу готовой. После обрыва сверьте записи с сохранённым, продолжайте незавершённое и не создавайте дубли; отсутствие или расхождение результата требует повторной сверки, а не отметки «готово». Счётчики выводите из этого учёта. Отдельные журнал, контрольная точка и запись намерения перед каждым чтением здесь не обязательны. Охват, источники выводов и финальная приёмка остаются обязательными.

   Полный режим нужен для отправок, покупок, публикаций и иных внешних изменений, невоспроизводимых результатов, нескольких писателей либо обязательной истории действий. При неясных последствиях сначала установите границу; неизвестность не разрешает упрощение. Уже действующий журнал или обязательные правила runtime не заменяйте отчётом.
...
- упрощённый учёт выбран при внешних изменениях, невоспроизводимых результатах, нескольких писателях или обязательной истории действий;
